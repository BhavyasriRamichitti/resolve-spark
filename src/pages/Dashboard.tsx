          ...
          <Card className="glass-card p-6 hover-scale">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white counter-animate">{stats.total}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-white/70 text-sm mb-2">{request.description}</p>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-white text-sm font-medium">{request.assignedTo}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <Card className="glass-card p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Button variant="outline" className="border-white/30 text-white hover:bg-white/10 h-20 flex-col gap-2">
